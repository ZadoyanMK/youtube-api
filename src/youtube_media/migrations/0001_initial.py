# Generated by Django 2.2 on 2019-06-07 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hash_data', models.CharField(db_index=True, max_length=64, unique=True)),
                ('full_url', models.CharField(max_length=512)),
                ('region', models.CharField(max_length=16)),
                ('etag', models.CharField(max_length=256)),
                ('next_page', models.CharField(blank=True, max_length=64, null=True)),
                ('prev_page', models.CharField(blank=True, max_length=64, null=True)),
                ('page_token', models.CharField(blank=True, db_index=True, max_length=64, null=True, unique=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
            ],
        ),
